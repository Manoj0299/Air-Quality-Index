...
loaded_model = pickle.load(open('C:/Users/MONOJ/JUPYTER NOTEBOOK/AQI_Prediction/trained_model.sav', 'rb'))
...
def main():
    ...
    if st.button('AQI Result'):
        air_quality = AQI_prediction([MinimumTemperature, MaximumTemperature, AverageTemperature,
